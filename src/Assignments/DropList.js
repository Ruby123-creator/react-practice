...
function DropList() 
{
    ...
    <select name="city" id="#city" onChange={(e)=>setSelectedcity(e.target.value)}>
     {
        states[Selectedstate]?.city.map((item ,i)=>{
            return(
                <option value={i} key={i}>{item.name}</option>
            )
    ...
    <select name="" id="landmark" onChange={(e)=>setSelectedlandmark(e.target.value)}>
     {
        states[Selectedstate]?.city[Selectedcity]?.landmarks.map((item ,i)=>{
           return(
            <option value={i} key={i}>{item.name}</option>
           ) 
     })
    ...
    <div>
        ...
        <div id="#landmark-name">
           {
            states[Selectedstate]?.city[Selectedcity]?.landmarks[Selectedlandmark]?.name
           }
        </div>
